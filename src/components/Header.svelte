...
<header
  class="fixed top-0 left-0 right-0 z-50 h-14 border-b border-[#EDEDF0] bg-white dark:bg-gray-900 dark:border-gray-800"
>
  <div class="h-full px-4 lg:pl-7 flex items-center justify-between">
    ...
    <div class="flex items-center gap-2 sm:gap-4">
      ...
      <a
        href="https://github.com/Andndre/docs-hmjti.git"
        target="_blank"
